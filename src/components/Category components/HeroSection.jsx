    ...
    <div className='w-[100%] h-[122vh] relative bg-[url("/images/hero-bg.jpeg")] bg-top bg-contain bg-no-repeat font-monteserrat'>
      ...
      <main className="pt-[15vh] w-full h-full absolute top-0 left-0 bg-gradient-to-t to-transparent from-webBlue text-white flex flex-col justify-evenly items-center">
        ...
        <div className="w-full flex justify-center">
          <h2 className="font-medium flex gap-3 text-4xl border-b-2 border-white pb-3">
            What are you <p className="italic text-webGreen">Looking for </p> ?{" "}
            <div className="w-[5vw]"></div> <IoSearch />{" "}
          </h2>
        </div>

        <div className="w-full px-[10vw]">
          <div className="flex  gap-2">
            <button className="border-2 border-zinc-500 text-zinc-300 font-medium flex items-center gap-1 text-md px-4 py-1 rounded-md">
              {" "}
              <TiArrowSortedDown /> By Genre{" "}
            </button>
            <button className="border-2 border-webGreen hover:border-zinc-300 text-zinc-300 font-medium flex items-center gap-1 text-md px-4 py-1 rounded-md">
              {" "}
              Action{" "}
            </button>
            <button className="border-2 border-webGreen hover:border-zinc-300 text-zinc-300 font-medium flex items-center gap-1 text-md px-4 py-1 rounded-md">
